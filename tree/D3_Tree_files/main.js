...
// Tree configuration
var branches = [];
var seed = {i: 0, x: 320, y: 450, a: 0, l: 100, d:0}; // a = angle, l = length, d = depth
...
function highlightParents(d) {
	var colour = d3.event.type === 'mouseover' ? '#777' : '#777';
	var depth = d.d;
	for(var i = 0; i <= depth; i++) {
		d3.select('#id-'+parseInt(d.i)).style('stroke', colour).style('opacity',1);
		d = branches[d.parent];
	}	
}
