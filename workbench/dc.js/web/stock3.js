...
var signalChart = dc.pieChart("#signal-chart");
var divDeneme = d3.select("body").selectAll("#category1-chart");
var pieNumber = 12;
var catname =[];
catname[0]= " "
catname[1] = "chemotaxis";
catname[2] = "enzyme";
catname[3] = "GPCR";
catname[4] = "morpho";
catname[5] = "signal";
...
var catChart =[]
catChart[0] = 0;
for (var i=1;i<=pieNumber;i++){
	var text = "#category"+i+"-chart";
	catChart[i] = dc.pieChart(text);
	}


var category1Chart = dc.pieChart("#category1-chart");
var category2Chart = dc.pieChart("#category2-chart");
var category3Chart = dc.pieChart("#category3-chart");
var category4Chart = dc.pieChart("#category4-chart");
var category5Chart = dc.pieChart("#category5-chart");
var category6Chart = dc.pieChart("#category6-chart");
var category6Chart = dc.pieChart("#category7-chart");
var category6Chart = dc.pieChart("#category8-chart");
var category6Chart = dc.pieChart("#category9-chart");
var category6Chart = dc.pieChart("#category10-chart");
var category6Chart = dc.pieChart("#category11-chart");
var category6Chart = dc.pieChart("#category12-chart");
var ribosomeChart = dc.pieChart("#ribosome-chart");

var enzymeChart = dc.pieChart("#enzyme-chart");
var GPCRChart = dc.pieChart("#GPCR-chart");
var morphoChart = dc.pieChart("#morphology-chart");
//var histogramChart = dc.pieChart("#histogram-chart");
...
//```
d3.csv("humanVSrat_merged.csv", function (data) {
    /* since its a csv file we need to format the data a bit */
    var numberFormat = d3.format(".2f");
//Initialize of Data Formats
    data.forEach(function (d) {
	d.chemo = +d.chemotaxis;
	d.enzyme = +d.enzyme;
	d.signal = +d.signal;
	d.GPCR = +d.GPCR;
	d.morpho = +d.morpho;
...
*/
 ...
 /*
    ...
    gainOrLossChart
        .width(pieWidth) // (optional) define chart width, :default = 200
        .height(pieHeight) // (optional) define chart height, :default = 200
    ...
    anyPie
	 ...
	 .dimension(anyVar)
         .group(anyGroup)
	 .label(function (d) {
	      if (anyPie.hasFilter() && !anyPie.hasFilter(d.key))
	         return d.key + "(0%)";
	      return d.key + "(" + Math.floor(d.value / all.value() * 100) + "%)";
	  });
    ...
    catChart[1]
	 ...
	 .dimension(dimensions[1])
         .group(thegroups[1])
	 .label(function (d) {
	      if (catChart[1].hasFilter() && !catChart[1].hasFilter(d.key))
	         return d.key + "(0%)";
	      return d.key + "(" + Math.floor(d.value / all.value() * 100) + "%)";
	  });
    ...
    category1Chart
         ...
         .height(pieHeight)
         .radius(pieRadius)
	 .dimension(category1Var)
         .group(category1Group)
	 .label(function (d) {
	      if (category1Chart.hasFilter() && !category1Chart.hasFilter(d.key))
	         return d.key + "(0%)";
	      return d.key + "(" + Math.floor(d.value / all.value() * 100) + "%)";
	  });
    category2Chart
         ...
         .height(pieHeight)
         .radius(pieRadius)
	 .dimension(category2Var)
         .group(category2Group)
	 .label(function (d) {
	      if (category2Chart.hasFilter() && !category2Chart.hasFilter(d.key))
	         return d.key + "(0%)";
	      return d.key + "(" + Math.floor(d.value / all.value() * 100) + "%)";
	  });
    category3Chart
         ...
         .height(pieHeight)
         .radius(pieRadius)
	 .dimension(category3Var)
         .group(category3Group)
	 .label(function (d) {
	      if (category3Chart.hasFilter() && !category3Chart.hasFilter(d.key))
	         return d.key + "(0%)";
	      return d.key + "(" + Math.floor(d.value / all.value() * 100) + "%)";
	  });
    category4Chart
         ...
         .height(pieHeight)
         .radius(pieRadius)
	 .dimension(category4Var)
         .group(category4Group)
	 .label(function (d) {
	      if (category4Chart.hasFilter() && !category4Chart.hasFilter(d.key))
	         return d.key + "(0%)";
	      return d.key + "(" + Math.floor(d.value / all.value() * 100) + "%)";
	  });
    category5Chart
         ...
         .height(pieHeight)
         .radius(pieRadius)
	 .dimension(category5Var)
         .group(category5Group)
	 .label(function (d) {
	      if (category5Chart.hasFilter() && !category5Chart.hasFilter(d.key))
	         return d.key + "(0%)";
	      return d.key + "(" + Math.floor(d.value / all.value() * 100) + "%)";
	  });
    category6Chart
         ...
         .height(pieHeight)
         .radius(pieRadius)
	 .dimension(category6Var)
         .group(category6Group)
	 .label(function (d) {
	      if (category6Chart.hasFilter() && !category6Chart.hasFilter(d.key))
	         return d.key + "(0%)";
	      return d.key + "(" + Math.floor(d.value / all.value() * 100) + "%)";
	  });
     signalChart
	  ...
	  .group(signalGroup)
	  .label(function (d) {
	      if (signalChart.hasFilter() && !signalChart.hasFilter(d.key))
	         return d.key + "(0%)";
	      return d.key + "(" + Math.floor(d.value / all.value() * 100) + "%)";
	  });
     ...
     ribosomeChart
	  ...
	  .group(ribosomeGroup)
	  .label(function (d) {
	      if (ribosomeChart.hasFilter() && !ribosomeChart.hasFilter(d.key))
	         return d.key + "(0%)";
	      return d.key + "(" + Math.floor(d.value / all.value() * 100) + "%)";
     ...
     GPCRChart
	  ...
	  .group(GPCRGroup)
	  .label(function (d) {
	      if (GPCRChart.hasFilter() && !GPCRChart.hasFilter(d.key))
	         return d.key + "(0%)";
	      return d.key + "(" + Math.floor(d.value / all.value() * 100) + "%)";
     ...
     enzymeChart
	  ...
	  .group(enzymeGroup)
	  .label(function (d) {
	      if (enzymeChart.hasFilter() && !enzymeChart.hasFilter(d.key))
	         return d.key + "(0%)";
	      return d.key + "(" + Math.floor(d.value / all.value() * 100) + "%)";
     ...
     morphoChart
	  ...
	  .group(morphoGroup)
	  .label(function (d) {
	      if (morphoChart.hasFilter() && !morphoChart.hasFilter(d.key))
	         return d.key + "(0%)";
	      return d.key + "(" + Math.floor(d.value / all.value() * 100) + "%)";
